...
public class ChatHandelar extends Thread implements Initializable{
    Connection con;
    String username = "";
    String role = "";
    BorderPane pane1;
    ...
    public void run() {
         try {
             ...
             while (true) {
                 if(i==100)break;
               /*  i++;
                  if(last.equalsIgnoreCase("ar")){
                      Object obj = ip.readObject();
                      ArrayList<Person> computers = (ArrayList<Person>) obj;
                 ArrayList<Person> msg = (ArrayList<Person>) computers;
                 for(Person computer :msg){
                     System.out.println(computer.name);
                      ...
                      ArrayList<Person> msg = (ArrayList<Person>) computers;
                      for(Person computer :msg){
                          System.out.println("Else "+computer.name);
                      }*/
                // String msg = () ip.readObject();
            ...
            /*     Platform.runLater(new Runnable() {
                     ...
                     public void run() {
                         ...
                         Text text = new Text(Person.getName());
                         TextFlow textFlow = new TextFlow(text);
                         textFlow.setStyle("-fx-color:rgb(239,242,255);"
