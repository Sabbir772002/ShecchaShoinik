 ...
 */
        ...
        void profile(ActionEvent event) {
            try {
                ...
                Parent root = scene.root;
                UserProfile.ProfileController admin = (UserProfile.ProfileController) scene.controller;
    ...
    private TextField phone;
        ...
        public void output(){
            try{
                ...
                String sql = "SELECT Name,Username,Phone,Division,District,Mail FROM userlist Where Username = \'"+user.getText()+"\'";
